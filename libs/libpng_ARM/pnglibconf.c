 ...
 */
 ...
 PNG_DFN "" 
 PNG_DFN "/* libpng version 1.6.43 */" 
 PNG_DFN "" 
 PNG_DFN "/* Copyright (c) 2018-2024 Cosmin Truta */" 
...
/* option: MIPS_MSA_CHECK disabled
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_MIPS_MSA_CHECK_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      undef PNG_on /*default off*/
#    endif /*!enabled*/
#    ifdef PNG_on
#      define PNG_MIPS_MSA_CHECK_SUPPORTED
#    endif
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_MIPS_MSA_CHECK_SUPPORTED" 
#    ifdef PNG_set_MIPS_MSA_OPT
 PNG_DFN "ERROR: MIPS_MSA_CHECK sets MIPS_MSA_OPT: duplicate setting" 
 PNG_DFN "ERROR:    previous value: " PNG_set_MIPS_MSA_OPT
#    else
#     define PNG_set_MIPS_MSA_OPT  1
#    endif
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_MIPS_MSA_CHECK_SUPPORTED*/" 
#endif
...
/* option: DISABLE_ADLER32_CHECK disabled
 *   requires:   READ
 *   if:        
 *   enabled-by:
 *   sets:       */
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_DISABLE_ADLER32_CHECK_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      undef PNG_on /*default off*/
#    endif /*!enabled*/
#    ifdef PNG_on
...
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_DISABLE_ADLER32_CHECK_SUPPORTED" 
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_DISABLE_ADLER32_CHECK_SUPPORTED*/" 
#endif
...
/* option: MIPS_MMI_CHECK disabled
 *   requires:   ALIGNED_MEMORY
 *   if:        
 *   enabled-by:
 *   sets:       MIPS_MMI_OPT */
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_MIPS_MMI_CHECK_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      undef PNG_on /*default off*/
#    endif /*!enabled*/
#    ifdef PNG_on
#      define PNG_MIPS_MMI_CHECK_SUPPORTED
#    endif
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_MIPS_MMI_CHECK_SUPPORTED" 
#    ifdef PNG_set_MIPS_MMI_OPT
 PNG_DFN "ERROR: MIPS_MMI_CHECK sets MIPS_MMI_OPT: duplicate setting" 
 PNG_DFN "ERROR:    previous value: " PNG_set_MIPS_MMI_OPT
#    else
#     define PNG_set_MIPS_MMI_OPT  1
#    endif
#   endif /* definition */
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_MIPS_MMI_CHECK_SUPPORTED*/" 
#endif
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_MIPS_MSA_API_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      undef PNG_on /*default off*/
#    endif /*!enabled*/
#    ifdef PNG_on
#      define PNG_MIPS_MSA_API_SUPPORTED
#    endif
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_MIPS_MSA_API_SUPPORTED" 
#    ifdef PNG_set_MIPS_MSA_OPT
 PNG_DFN "ERROR: MIPS_MSA_API sets MIPS_MSA_OPT: duplicate setting" 
 PNG_DFN "ERROR:    previous value: " PNG_set_MIPS_MSA_OPT
#    else
#     define PNG_set_MIPS_MSA_OPT  1
#    endif
...
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_MIPS_MSA_API_SUPPORTED*/" 
#endif
...
#   define PNG_not_enabled 1
   /* enabled by */
#   ifndef PNG_MIPS_MMI_API_SUPPORTED /*!command line*/
#    ifdef PNG_not_enabled /*!enabled*/
#      undef PNG_on /*default off*/
#    endif /*!enabled*/
#    ifdef PNG_on
#      define PNG_MIPS_MMI_API_SUPPORTED
#    endif
#   endif /*!command line*/
#   ifdef PNG_on
 PNG_DFN "#define PNG_MIPS_MMI_API_SUPPORTED" 
#    ifdef PNG_set_MIPS_MMI_OPT
 PNG_DFN "ERROR: MIPS_MMI_API sets MIPS_MMI_OPT: duplicate setting" 
 PNG_DFN "ERROR:    previous value: " PNG_set_MIPS_MMI_OPT
#    else
#     define PNG_set_MIPS_MMI_OPT  1
#    endif
...
#endif /*requires, if*/
#ifndef  PNG_on
 PNG_DFN "/*#undef PNG_MIPS_MMI_API_SUPPORTED*/" 
#endif
 ...
 *   requires:  
 *   if:        
 *   enabled-by: ARM_NEON_API POWERPC_VSX_API MIPS_MSA_API MIPS_MMI_API DISABLE_ADLER32_CHECK READ READ_sRGB WRITE_sRGB
 *   sets:       */
#undef PNG_on
#define PNG_on 1
#undef PNG_no_if
...
#   undef PNG_not_enabled /*MIPS_MSA_API*/
#endif
#ifdef PNG_MIPS_MMI_API_SUPPORTED
#   undef PNG_not_enabled /*MIPS_MMI_API*/
#endif
#ifdef PNG_DISABLE_ADLER32_CHECK_SUPPORTED
#   undef PNG_not_enabled /*DISABLE_ADLER32_CHECK*/
#endif
#ifdef PNG_READ_SUPPORTED
#   undef PNG_not_enabled /*READ*/
#endif
 ...
 *   requires:
 *   default:   */
#ifdef PNG_MIPS_MSA_OPT
 PNG_DFN "#define PNG_MIPS_MSA_OPT @" PNG_MIPS_MSA_OPT "@" 
#else /* use default */
# ifdef PNG_set_MIPS_MSA_OPT
 PNG_DFN "#define PNG_MIPS_MSA_OPT @" PNG_set_MIPS_MSA_OPT "@" 
#  define PNG_MIPS_MSA_OPT 1
# endif /* defaults */
#endif /* setting MIPS_MSA_OPT */
 ...
 *   requires:
 *   default:   */
#ifdef PNG_MIPS_MMI_OPT
 PNG_DFN "#define PNG_MIPS_MMI_OPT @" PNG_MIPS_MMI_OPT "@" 
#else /* use default */
# ifdef PNG_set_MIPS_MMI_OPT
 PNG_DFN "#define PNG_MIPS_MMI_OPT @" PNG_set_MIPS_MMI_OPT "@" 
#  define PNG_MIPS_MMI_OPT 1
# endif /* defaults */
#endif /* setting MIPS_MMI_OPT */
